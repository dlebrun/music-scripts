...
sudo apt install build-essential git curl docker.io awscli flac kubuntu-restricted-addons kubuntu-restricted-extras network-manager-openvpn software-properties-common dbeaver-ce qgit
